...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Wind mechanical model associated with this wind generator type 1 or 2 model. Default: nullptr */
		CIMPP::WindMechIEC* WindMechIEC;

		/** \brief Wind turbune protection model associated with this wind generator type 1 or 2 model. Default: nullptr */
