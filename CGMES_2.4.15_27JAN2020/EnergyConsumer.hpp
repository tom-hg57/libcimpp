...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Load dynamics model used to describe dynamic behavior of this energy consumer. Default: nullptr */
		...
		/** \brief Active power of the load that is a fixed quantity. Load sign convention is used, i.e. positive sign means flow out from a node. Default: 0.0 */
		CIMPP::ActivePower pfixed;

		/** \brief Fixed active power as per cent of load group fixed active power. Load sign convention is used, i.e. positive sign means flow out from a node. Default: 0.0 */
		...
		/** \brief Reactive power of the load that is a fixed quantity. Load sign convention is used, i.e. positive sign means flow out from a node. Default: 0.0 */
		CIMPP::ReactivePower qfixed;

		/** \brief Fixed reactive power as per cent of load group fixed reactive power. Load sign convention is used, i.e. positive sign means flow out from a node. Default: 0.0 */
