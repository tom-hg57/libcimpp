...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Notch filter 1 (high-frequency band): Three dB bandwidth (B). Default: 0.0 */
		CIMPP::Simple_Float bwh1;

		/** \brief Notch filter 2 (high-frequency band): Three dB bandwidth (B). Default: 0.0 */
		CIMPP::Simple_Float bwh2;

		/** \brief Notch filter 1 (low-frequency band): Three dB bandwidth (B). Default: 0.0 */
		CIMPP::Simple_Float bwl1;

		/** \brief Notch filter 2 (low-frequency band): Three dB bandwidth (B). Default: 0.0 */
		...
		/** \brief Notch filter 1 (high-frequency band): filter frequency (omega). Default: 0.0 */
		CIMPP::Simple_Float omeganh1;

		/** \brief Notch filter 2 (high-frequency band): filter frequency (omega). Default: 0.0 */
		CIMPP::Simple_Float omeganh2;

		/** \brief Notch filter 1 (low-frequency band): filter frequency (omega). Default: 0.0 */
		CIMPP::Simple_Float omeganl1;

		/** \brief Notch filter 2 (low-frequency band): filter frequency (omega). Default: 0.0 */
