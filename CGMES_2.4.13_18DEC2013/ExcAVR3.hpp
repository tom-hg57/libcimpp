...
namespace CIMPP
{
	...
	public:
		...
		/** \brief AVR gain (K).  Typical Value = 3000. Default: 0.0 */
		...
		/** \brief AVR time constant (T).  Typical Value = 220. Default: 0.0 */
		CIMPP::Seconds t1;

		/** \brief AVR time constant (T).  Typical Value = 1.6. Default: 0.0 */
		CIMPP::Seconds t2;

		/** \brief AVR time constant (T).  Typical Value = 0.66. Default: 0.0 */
		CIMPP::Seconds t3;

		/** \brief AVR time constant (T).  Typical Value = 0.07. Default: 0.0 */
		CIMPP::Seconds t4;

		/** \brief Exciter time constant (T).  Typical Value = 1. Default: 0.0 */
		CIMPP::Seconds te;

		/** \brief Maximum AVR output (V).  Typical Value = -7.5. Default: 0.0 */
		CIMPP::PU vrmn;

		/** \brief Minimum AVR output (V).  Typical Value = 7.5. Default: 0.0 */
		CIMPP::PU vrmx;
