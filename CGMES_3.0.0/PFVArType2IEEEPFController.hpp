...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Integral gain of the pf controller (<i>K</i><i><sub>I</sub></i>).  Typical value = 1. Default: 0.0 */
		CIMPP::PU ki;

		/** \brief Proportional gain of the pf controller (<i>K</i><i><sub>P</sub></i>).  Typical value = 1. Default: 0.0 */
		CIMPP::PU kp;

		/** \brief Power factor reference (<i>P</i><i><sub>FREF</sub></i>). Default: 0.0 */
		CIMPP::PU pfref;

		/** \brief Maximum output of the pf controller (<i>V</i><i><sub>CLMT</sub></i>).  Typical value = 0,1. Default: 0.0 */
		CIMPP::PU vclmt;
