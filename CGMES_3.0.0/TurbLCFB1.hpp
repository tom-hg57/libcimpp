...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Controller deadband (<i>db</i>).  Typical value = 0. Default: 0.0 */
		CIMPP::PU db;

		/** \brief Maximum control error (<i>Emax</i>) (see parameter detail 4).  Typical value = 0,02. Default: 0.0 */
		CIMPP::PU emax;

		/** \brief Frequency bias gain (<i>Fb</i>).  Typical value = 0. Default: 0.0 */
		CIMPP::PU fb;
		...
		/** \brief Maximum turbine speed/load reference bias (<i>Irmax</i>) (see parameter detail 3).  Typical value = 0. Default: 0.0 */
		CIMPP::PU irmax;

		/** \brief Integral gain (<i>Ki</i>).  Typical value = 0. Default: 0.0 */
		CIMPP::PU ki;
		...
		/** \brief Power controller setpoint (<i>Pmwset</i>) (see parameter detail 1).  Unit = MW. Typical value = 0. Default: 0.0 */
		...
		/** \brief Power transducer time constant (<i>Tpelec</i>) (&gt;= 0).  Typical value = 0. Default: 0.0 */
