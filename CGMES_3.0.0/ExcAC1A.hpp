...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Rectifier loading factor proportional to commutating reactance (<i>Kc</i>) (&gt;= 0). Typical value = 0,2. Default: 0.0 */
		CIMPP::PU kc;

		/** \brief Demagnetizing factor, a function of exciter alternator reactances (<i>Kd</i>) (&gt;= 0).  Typical value = 0,38. Default: 0.0 */
		CIMPP::PU kd;
		...
		/** \brief Coefficient to allow different usage of the model (<i>Kf1</i>) (&gt;= 0).  Typical value = 0. Default: 0.0 */
		CIMPP::PU kf1;

		/** \brief Coefficient to allow different usage of the model (<i>Kf2</i>) (&gt;= 0).  Typical value = 1. Default: 0.0 */
		CIMPP::PU kf2;
		...
		/** \brief Exciter alternator output voltages back of commutating reactance at which saturation is defined (<i>Ve1</i>) (&gt; 0).  Typical value = 4,18. Default: 0.0 */
		CIMPP::PU ve1;

		/** \brief Exciter alternator output voltages back of commutating reactance at which saturation is defined (<i>Ve2</i>) (&gt; 0).  Typical value = 3,14. Default: 0.0 */
		CIMPP::PU ve2;

		/** \brief Maximum voltage regulator outputs (<i>Vrmax</i>) (&gt; 0).  Typical value = 6,03. Default: 0.0 */
		CIMPP::PU vrmax;

		/** \brief Minimum voltage regulator outputs (<i>Vrmin</i>) (&lt; 0).  Typical value = -5,43. Default: 0.0 */
		CIMPP::PU vrmin;
