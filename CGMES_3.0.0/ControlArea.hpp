...
namespace CIMPP
{
	...
	public:
		...
		/** \brief The generating unit specifications for the control area. Default: {} */
		...
		/** \brief The specified positive net interchange into the control area, i.e. positive sign means flow into the area. Default: 0.0 */
		CIMPP::ActivePower netInterchange;

		/** \brief Active power net interchange tolerance. The attribute shall be a positive value or zero. Default: 0.0 */
