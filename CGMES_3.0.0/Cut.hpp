...
namespace CIMPP
{
	...
	public:
		...
		/** \brief The line segment to which the cut is applied. Default: nullptr */
		CIMPP::ACLineSegment* ACLineSegment;

		/** \brief The length to the place where the cut is located starting from side one of the cut line segment, i.e. the line segment Terminal with sequenceNumber equal to 1. Default: 0.0 */
