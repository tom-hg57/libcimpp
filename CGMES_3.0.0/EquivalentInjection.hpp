...
namespace CIMPP
{
	...
	public:
		...
		/** \brief The reactive capability curve used by this equivalent injection. Default: nullptr */
		...
		/** \brief Maximum reactive power of the injection.  Used for modelling of infeed for load flow exchange. Not used for short circuit modelling.  If maxQ and minQ are not used ReactiveCapabilityCurve can be used. Default: 0.0 */
		CIMPP::ReactivePower maxQ;

		/** \brief Minimum active power of the injection. Default: 0.0 */
		CIMPP::ActivePower minP;

		/** \brief Minimum reactive power of the injection.  Used for modelling of infeed for load flow exchange. Not used for short circuit modelling.  If maxQ and minQ are not used ReactiveCapabilityCurve can be used. Default: 0.0 */
		...
		/** \brief The target voltage for voltage regulation. The attribute shall be a positive value. Default: 0.0 */
