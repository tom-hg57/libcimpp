...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Power factor or VAr controller type 1 model associated with this excitation system model. Default: nullptr */
		CIMPP::PFVArControllerType1Dynamics* PFVArControllerType1Dynamics;

		/** \brief Power factor or VAr controller type 2 model associated with this excitation system model. Default: nullptr */
