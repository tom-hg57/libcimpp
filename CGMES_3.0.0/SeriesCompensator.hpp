...
namespace CIMPP
{
	...
	public:
		...
		/** \brief The maximum current the varistor is designed to handle at specified duration. It is used for short circuit calculations and exchanged only if SeriesCompensator.varistorPresent is true. The attribute shall be a positive value. Default: 0.0 */
		CIMPP::CurrentFlow varistorRatedCurrent;

		/** \brief The dc voltage at which the varistor starts conducting. It is used for short circuit calculations and exchanged only if SeriesCompensator.varistorPresent is true. Default: 0.0 */
