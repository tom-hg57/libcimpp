...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Asynchronous machine dynamics model used to describe dynamic behaviour of this asynchronous machine. Default: nullptr */
		...
		/** \brief Efficiency of the asynchronous machine at nominal operation as a percentage. Indicator for converter drive motors. Used for short circuit data exchange according to IEC 60909. Default: 0.0 */
		...
		/** \brief Nameplate data indicates if the machine is 50 Hz or 60 Hz. Default: 0.0 */
		CIMPP::Frequency nominalFrequency;

		/** \brief Nameplate data.  Depends on the slip and number of pole pairs. Default: 0.0 */
		...
		/** \brief Rated mechanical power (Pr in IEC 60909-0). Used for short circuit data exchange according to IEC 60909. Default: 0.0 */
