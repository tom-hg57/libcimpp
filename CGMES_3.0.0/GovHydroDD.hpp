...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Maximum gate opening (<i>Gmax</i>) (&gt; GovHydroDD.gmin).  Typical value = 0. Default: 0.0 */
		CIMPP::PU gmax;

		/** \brief Minimum gate opening (<i>Gmin</i>) (&lt; GovHydroDD.gmax).  Typical value = 0. Default: 0.0 */
		CIMPP::PU gmin;
		...
		/** \brief Single derivative gain (<i>K1</i>).  Typical value = 3,6. Default: 0.0 */
		CIMPP::PU k1;

		/** \brief Double derivative gain (<i>K2</i>).  Typical value = 0,2. Default: 0.0 */
		CIMPP::PU k2;

		/** \brief Gate servo gain (<i>Kg</i>).  Typical value = 3. Default: 0.0 */
		CIMPP::PU kg;

		/** \brief Integral gain (<i>Ki</i>).  Typical value = 1. Default: 0.0 */
		CIMPP::PU ki;
		...
		/** \brief Maximum gate opening, PU of <i>MWbase</i> (<i>Pmax</i>) (&gt; GovHydroDD.pmin).  Typical value = 1. Default: 0.0 */
		CIMPP::PU pmax;

		/** \brief Minimum gate opening, PU of <i>MWbase</i> (<i>Pmin</i>) (&gt; GovHydroDD.pmax).  Typical value = 0. Default: 0.0 */
		CIMPP::PU pmin;
