...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Turbine damping factor (Dturb).  Typical Value = 0.2. Default: 0.0 */
		CIMPP::PU dturb;

		/** \brief Intentional db hysteresis (eps).  Unit = Hz.  Typical Value = 0. Default: 0.0 */
		CIMPP::Frequency eps;

		/** \brief Maximum governor output (Gmax).  Typical Value = 1.05. Default: 0.0 */
		CIMPP::PU gmax;

		/** \brief Minimum governor output (Gmin).  Typical Value = -0.05. Default: 0.0 */
		CIMPP::PU gmin;
		...
		/** \brief Turbine nominal head (H0).  Typical Value = 1. Default: 0.0 */
		CIMPP::PU h0;
		...
		/** \brief Gate servo gain (Kg).  Typical Value = 2. Default: 0.0 */
		CIMPP::PU kg;

		/** \brief Integral gain (Ki).  Typical Value = 0.5. Default: 0.0 */
		CIMPP::PU ki;
		...
		/** \brief No-load turbine flow at nominal head (Qnl).  Typical Value = 0.08. Default: 0.0 */
		CIMPP::PU qnl;

		/** \brief Steady-state droop (R).  Typical Value = 0.05. Default: 0.0 */
		CIMPP::PU r;

		/** \brief Lead time constant 1 (T1).  Typical Value = 1.5. Default: 0.0 */
		CIMPP::Seconds t1;

		/** \brief Lag time constant 1 (T2).  Typical Value = 0.1. Default: 0.0 */
		CIMPP::Seconds t2;

		/** \brief Lead time constant 2 (T3).  Typical Value = 1.5. Default: 0.0 */
		CIMPP::Seconds t3;

		/** \brief Lag time constant 2 (T4).  Typical Value = 0.1. Default: 0.0 */
		CIMPP::Seconds t4;

		/** \brief Lead time constant 3 (T5).  Typical Value = 0. Default: 0.0 */
		CIMPP::Seconds t5;

		/** \brief Lag time constant 3 (T6).  Typical Value = 0.05. Default: 0.0 */
		CIMPP::Seconds t6;

		/** \brief Lead time constant 4 (T7).  Typical Value = 0. Default: 0.0 */
		CIMPP::Seconds t7;

		/** \brief Lag time constant 4 (T8).  Typical Value = 0.05. Default: 0.0 */
		CIMPP::Seconds t8;

		/** \brief Input filter time constant (Td).  Typical Value = 0.05. Default: 0.0 */
		CIMPP::Seconds td;

		/** \brief Gate servo time constant (Tp).  Typical Value = 0.05. Default: 0.0 */
		CIMPP::Seconds tp;

		/** \brief Power feedback time constant (Tt).  Typical Value = 0. Default: 0.0 */
		CIMPP::Seconds tt;

		/** \brief Water inertia time constant (Tw).  Typical Value = 1. Default: 0.0 */
		CIMPP::Seconds tw;

		/** \brief Maximum gate closing velocity (Velcl).  Unit = PU/sec.  Typical Value = -0.2. Default: 0.0 */
		CIMPP::Simple_Float velcl;

		/** \brief Maximum gate opening velocity (Velop).  Unit = PU/sec.  Typical Value = 0.2. Default: 0.0 */
