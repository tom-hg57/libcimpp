...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Saturation factor at rated terminal voltage (S1) (> or =0).  Not used by simplified model.  Defined by defined by S(E1) in the SynchronousMachineSaturationParameters diagram.  Typical Value = 0.02. Default: 0.0 */
		CIMPP::Simple_Float saturationFactor;

		/** \brief Saturation factor at 120% of rated terminal voltage (S12) (> or =S1). Not used by the simplified model, defined by S(E2) in the SynchronousMachineSaturationParameters diagram.  Typical Value = 0.12. Default: 0.0 */
		CIMPP::Simple_Float saturationFactor120;

		/** \brief Stator leakage reactance (Xl) (> or =0). Typical Value = 0.15. Default: 0.0 */
		CIMPP::PU statorLeakageReactance;

		/** \brief Stator (armature) resistance (Rs) (> or =0). Typical Value = 0.005. Default: 0.0 */
