...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Exciter voltage at which exciter saturation is defined (Efd1).  Typical Value = 3.05. Default: 0.0 */
		CIMPP::PU efd1;

		/** \brief Exciter voltage at which exciter saturation is defined (Efd2).  Typical Value = 2.29. Default: 0.0 */
		CIMPP::PU efd2;
		...
		/** \brief Voltage regulator gain (Ka).  Typical Value = 300. Default: 0.0 */
		CIMPP::PU ka;
		...
		/** \brief Exciter saturation function value at the corresponding exciter voltage, Efd1 (Se[Eefd1]).  Typical Value = 0.279. Default: 0.0 */
		CIMPP::Simple_Float seefd1;

		/** \brief Exciter saturation function value at the corresponding exciter voltage, Efd2 (Se[Efd2]).  Typical Value = 0.117. Default: 0.0 */
		...
		/** \brief Exciter time constant, integration rate associated with exciter control (Te).  Typical Value = 1.33. Default: 0.0 */
		CIMPP::Seconds te;

		/** \brief Excitation control system stabilizer time constant (Tf).  Typical Value = 0.675. Default: 0.0 */
		CIMPP::Seconds tf;

		/** \brief Excitation control system stabilizer time constant (Tf1).  Typical Value = 0. Default: 0.0 */
		CIMPP::Seconds tf1;

		/** \brief Maximum voltage regulator output (Vrmax).  Typical Value = 4.95. Default: 0.0 */
		CIMPP::PU vrmax;

		/** \brief Minimum voltage regulator output (Vrmin).  Typical Value = -4.9. Default: 0.0 */
		CIMPP::PU vrmin;
