...
namespace CIMPP
{
	...
	public:
		...
		/** \brief Stabilizer output dead band (DeadBand).  Typical Value = 0. Default: 0.0 */
		CIMPP::PU deadband;
		...
		/** \brief Frequency/shaft speed input gain (K).  Typical Value = 5. Default: 0.0 */
		...
		/** \brief First WashOut (T).  Typical Value = 3.5. Default: 0.0 */
		CIMPP::Seconds tw1;

		/** \brief Second WashOut (T).  Typical Value = 0. Default: 0.0 */
		CIMPP::Seconds tw2;

		/** \brief  Default: false */
		CIMPP::Boolean vadat;

		/** \brief Stabilizer output max limit (V).  Typical Value = -0.1. Default: 0.0 */
		CIMPP::PU vsmn;

		/** \brief Stabilizer output min limit (V).  Typical Value = 0.1. Default: 0.0 */
		CIMPP::PU vsmx;
